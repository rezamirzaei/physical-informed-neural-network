...
from physical_informed_neural_network.config import DataConfig, PDEConfig
from physical_informed_neural_network.schemas import ObservationSet, ReferenceSolution
from physical_informed_neural_network.utils import latin_hypercube_sample
...
def generate_reference_solution(pde: PDEConfig, data: DataConfig) -> ReferenceSolution:
    ...
    u = _cole_hopf_solution(x, t, pde.viscosity, n_terms=150)
